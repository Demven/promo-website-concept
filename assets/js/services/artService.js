...
IR.MODULE.CONTENT.factory("irArtService", function($rootScope, irExtendService){
    ...
    function ArtService() {
        ...
        this.dataJSON = [
            ...
            {id: "103", contentType: "image", title: "Hover cup", category: "handmade", author: {firstName: "Frank", lastName: "Sinatra"}, contentSrc: "http://fotohost.by/images/2015/04/15/cup.jpg", aspectRatio: "1.22", infoPosition: "2"},
            {id: "104", contentType: "image", title: "Hover cup", category: "handmade", author: {firstName: "Frank", lastName: "Sinatra"}, contentSrc: "http://fotohost.by/images/2015/04/15/cup.jpg", aspectRatio: "1.22", infoPosition: "2"},
